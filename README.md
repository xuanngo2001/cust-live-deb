...
# Customizations Performed
  * Running install.sh ...
    ...
    * Total size = 320188K. Space Used = 320188K.
  * Running inst-min-con-00-linux-image.sh ...
    ...
    * Total size = 611496K. Space Used = 291308K.
  * Running inst-min-con-auto-log-root.sh ...
    * Total size = 611504K. Space Used = 8K.
  * Running inst-min-con-automount.sh ...
  ...
  * Running inst-zclean-00-zerosizing-docs.sh ...
    ...
    * Total size = 1929584K. Space Used = -72232K.
  * Running inst-zclean-99-end-cleanup.sh ...
    * Clean apt-get cache.
    * rm -rf /tmp/*.
    * Umount /sys, /dev/pts and /proc.
    * Add http://http.debian.net/debian/ in sources.list.
    * Total size = 1515768K. Space Used = -413816K.
