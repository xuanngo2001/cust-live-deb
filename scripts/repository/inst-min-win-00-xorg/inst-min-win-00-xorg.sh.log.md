* >>>>>>>>> Running inst-min-win-00-xorg.sh ...
  ...
  * Disk size = 1396840K. Space Used = 98964K.
  * The following NEW packages will be installed:
  ```bash
  keyboard-configuration libdrm-amdgpu1 libdrm-common libdrm-nouveau2
  libdrm-radeon1 libdrm2 libegl1-mesa libepoxy0 libevdev2 libfontenc1 libgbm1
  libgl1-mesa-glx libgudev-1.0-0 libice6 libinput-bin libinput10 libllvm3.9
  libmtdev1 libpciaccess0 libsensors4 libsm6 libwacom-common libwacom2
  ...
  libxpm4 libxshmfence1 libxt6 libxxf86vm1 x11-xkb-utils xauth xinit xkb-data
