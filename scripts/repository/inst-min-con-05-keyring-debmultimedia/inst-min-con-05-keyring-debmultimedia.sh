...
# Add deb-multimedia sources list
  GF_ADD_SOURCE_LIST live "deb http://www.deb-multimedia.org bookworm main non-free"
  GF_ADD_SOURCE_LIST live "deb http://www.deb-multimedia.org bookworm-backports main"
