* >>>>>>>>> Running inst-std-inet-firefox-esr.sh ...
  ...
  * Install the latest Firefox from Debian Mozilla team: Mozilla Firefox 60.2.2.
  ...
  * Disk size = 2566828K. Space Used = 205544K. Runtime = 00:00:00:14.
  * The following NEW packages will be installed:
  ```bash
firefox-esr libevent-2.0-5 libjsoncpp1 libvpx4
  ```
