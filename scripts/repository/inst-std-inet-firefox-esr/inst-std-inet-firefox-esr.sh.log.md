* >>>>>>>>> Running inst-std-inet-firefox-esr.sh ...
  ...
  * Install the latest Firefox from Debian Mozilla team: Mozilla Firefox 68.12.0esr.
  ...
  * Disk size = 3262396K. Space Used = 228116K. Runtime = 00:00:00:14.
  * The following NEW packages will be installed:
  ```bash
firefox-esr libjsoncpp1 libvpx5
  ```
