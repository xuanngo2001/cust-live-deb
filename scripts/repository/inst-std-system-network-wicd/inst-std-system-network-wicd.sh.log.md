* >>>>>>>>> Running inst-std-system-network-wicd.sh ...
  ...
  * Disk size = 3102292K. Space Used = 11732K. Runtime = 00:00:00:10.
  * The following NEW packages will be installed:
  ```bash
gir1.2-glib-2.0 libgirepository-1.0-1 libnl-3-200 libnl-genl-3-200 psmisc
python-dbus python-gi python-glade2 python-gobject python-wicd
