* >>>>>>>>> Running inst-xtra-games-freeciv-client-gtk.sh ...
  ...
  * After this operation, 5,245 kB of additional disk space will be used.
  ...
  * Disk size = 4562132K. Space Used = 55252K. Runtime = 00:00:00:07.
  * The following NEW packages will be installed:
  ```bash
freeciv-client-gtk freeciv-data freeciv-data* freeciv-server freeciv-sound-standard
gtk2-engines-pixbuf libmikmod3 libsdl1.2debian libsdl-mixer1.2
  ```
