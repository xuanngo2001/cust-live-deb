* >>>>>>>>> Running inst-std-graphic-xtra-mypaint.sh ...
  ...
  * Install mypaint.
  * Disk size = 2083968K. Space Used = 89016K. Runtime = 00:00:00:16.
...
libpython2.7-stdlib libpython-stdlib libquadmath0 mime-support mypaint
mypaint-data python python2.7 python2.7-minimal python-cairo
python-gi python-gi-cairo python-minimal python-numpy
  ```
