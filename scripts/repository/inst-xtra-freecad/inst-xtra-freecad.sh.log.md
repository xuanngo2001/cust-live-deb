* >>>>>>>>> Running inst-xtra-freecad.sh ...
  ...
  * Install freecad.
  * Disk size = 4792144K. Space Used = 468604K.
  * The following NEW packages will be installed:
  ```bash
  fonts-lyx freecad gstreamer1.0-alsa gstreamer1.0-plugins-base
  gstreamer1.0-pulseaudio libaudio2 libboost-program-options1.62.0
  libboost-python1.62.0 libboost-signals1.62.0 libcdparanoia0 libcoin80v5
  libfreeimage3 libgl2ps1 libjs-jquery libjs-jquery-ui libjs-sphinxdoc
  ...
  libqtwebkit4 libshiboken1.2v5 libsoqt4-20 libvisual-0.4-0 libwebpmux2
  libxerces-c3.1 libzipios++0v5 phonon phonon-backend-gstreamer
