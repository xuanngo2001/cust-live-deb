* >>>>>>>>> Running inst-xtra-zfs-dkms.sh ...
  ...
  * Disk size = 7056136K. Space Used = 60096K. Runtime = 00:00:04:53.
  * The following NEW packages will be installed:
  ```bash
build-essential* dkms* file libc6-dev* libelf-dev
libnvpair3linux libuutil3linux libzfs4linux libzpool5linux linux-headers-6.1.0-0.deb11.6-amd64*
