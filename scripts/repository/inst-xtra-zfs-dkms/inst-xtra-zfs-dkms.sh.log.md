...
<<<<<<< HEAD
  * Disk size = 6198756K. Space Used = 144424K. Runtime = 00:00:01:45.
=======
  * After this operation, 7,037 kB of additional disk space will be used.
  * Install instructions: https://github.com/zfsonlinux/zfs/wiki/Debian
  * Install zfs-dkms: version: 2.1.5-1~bpo11+1, DKMS style package. DKMS vs KMOD, see http://zfsonlinux.org/generic-deb.html
  * Install zfs-initramfs to be able to boot from ZFS.
  * Import existing ZFS partitions: zpool import -a
  * Disk size = 5990540K. Space Used = 59856K. Runtime = 00:00:02:36.
...
zfs-dkms
=======
libnvpair3linux libuutil3linux libzfs4linux libzpool5linux linux-headers-5.19.0-0.deb11.2-amd64*
