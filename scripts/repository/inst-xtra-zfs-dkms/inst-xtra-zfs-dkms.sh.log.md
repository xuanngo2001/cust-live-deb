...
<<<<<<< HEAD
  * Disk size = 7694032K. Space Used = 45936K. Runtime = 00:00:03:19.
...
linux-headers-6.12.63+deb13-amd64* linux-headers-amd64 lsb-release* module-assistant zfs-dkms
zfs-initramfs zfsutils-linux
=======
  * Disk size = 8076580K. Space Used = 56264K. Runtime = 00:00:03:57.
  * The following NEW packages will be installed:
  ```bash
build-essential* dkms* file libc6-dev* libdw1t64*
libelf1t64* libelf-dev libnvpair3linux libuutil3linux libzfs6linux
libzpool6linux libzstd-dev linux-headers-6.12.63+deb13-amd64* linux-headers-amd64 lsb-release*
