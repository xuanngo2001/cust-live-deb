* >>>>>>>>> Running inst-xtra-zfs-dkms.sh ...
  ...
  * Install zfs-dkms: version: 2.3.2-2~bpo12+1, DKMS style package. DKMS vs KMOD, see http://zfsonlinux.org/generic-deb.html
  * Install zfs-initramfs to be able to boot from ZFS.
  * Import existing ZFS partitions: zpool import -a
  * Disk size = 7604960K. Space Used = 47640K. Runtime = 00:00:06:51.
...
linux-headers-6.12.33+deb12-amd64* linux-headers-amd64 lsb-release* module-assistant zfs-dkms
