* >>>>>>>>> Running inst-xtra-zfs-dkms.sh ...
  ...
  * Install zfs-dkms: version: 2.3.1-1~bpo12+1, DKMS style package. DKMS vs KMOD, see http://zfsonlinux.org/generic-deb.html
  * Install zfs-initramfs to be able to boot from ZFS.
  * Import existing ZFS partitions: zpool import -a
  * Disk size = 7598812K. Space Used = 47488K. Runtime = 00:00:05:28.
...
linux-headers-6.12.32+bpo-amd64* linux-headers-amd64 lsb-release* module-assistant zfs-dkms
