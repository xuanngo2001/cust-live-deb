* >>>>>>>>> Running inst-xtra-zfs-dkms.sh ...
  ...
  * After this operation, 3,585 kB of additional disk space will be used.
  ...
  * Install zfs-dkms: version: 0.7.12-2+deb10u1~bpo9+1, DKMS style package. DKMS vs KMOD, see http://zfsonlinux.org/generic-deb.html
  * Install zfs-initramfs to be able to boot from ZFS.
  * Import existing ZFS partitions: zpool import -a
  * Disk size = 3859792K. Space Used = 40204K. Runtime = 00:00:05:19.
  * The following NEW packages will be installed:
  ```bash
build-essential* dkms* file libc6-dev* libelf-dev
libnvpair1linux libuutil1linux libzfs2linux libzpool2linux linux-headers-4.19.0-0.bpo.6-amd64*
