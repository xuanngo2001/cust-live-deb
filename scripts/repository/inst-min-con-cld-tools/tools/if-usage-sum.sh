...
TOTAL_RECEIVED_STR=$(numfmt --to=iec-i --suffix=B --format="%5f" "${TOTAL_BYTES_RECEIVED}")
TOTAL_TRANSMITTED_STR=$(numfmt --to=iec-i --suffix=B --format="%5f" "${TOTAL_BYTES_TRANSMITTED}")
