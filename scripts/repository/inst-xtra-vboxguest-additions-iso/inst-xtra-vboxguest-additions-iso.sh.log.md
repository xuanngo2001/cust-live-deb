* >>>>>>>>> Running inst-xtra-vboxguest-additions-iso.sh ...
  ...
  * Disk size = 8620280K. Space Used = 153400K. Runtime = 00:00:01:55.
  * The following NEW packages will be installed:
  ```bash
build-essential dkms dpkg-dev g++ g++-12
libc6-dev* libdpkg-perl libstdc++-12-dev linux-headers-6.12.33+deb12-amd64 linux-headers-6.12.33+deb12-common
linux-headers-amd64 linux-kbuild-6.12.33+deb12 lsb-release make pahole
patch
  ```
