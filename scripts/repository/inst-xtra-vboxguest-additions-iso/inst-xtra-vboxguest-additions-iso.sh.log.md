* >>>>>>>>> Running inst-xtra-vboxguest-additions-iso.sh ...
  ...
  * Disk size = 5757312K. Space Used = 71812K. Runtime = 00:00:00:41.
  * The following NEW packages will be installed:
  ```bash
build-essential* dctrl-tools dkms libc6-dev* linux-compiler-gcc-8-x86
linux-headers-5.10.0-0.bpo.5-amd64 linux-headers-5.10.0-0.bpo.5-common linux-headers-amd64 linux-kbuild-5.10
  ```
