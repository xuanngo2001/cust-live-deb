* >>>>>>>>> Running inst-xtra-vboxguest-additions-iso.sh ...
  ...
  * Disk size = 8716440K. Space Used = 144412K. Runtime = 00:00:00:58.
  * The following NEW packages will be installed:
  ```bash
build-essential dkms dpkg-dev g++ g++-12
libc6-dev* libdpkg-perl libstdc++-12-dev linux-headers-6.12.12+bpo-amd64 linux-headers-6.12.12+bpo-common
linux-headers-amd64 linux-kbuild-6.12.12+bpo lsb-release make patch
  ```
