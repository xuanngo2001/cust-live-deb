...
URL=http://download.virtualbox.org/virtualbox/6.1.6/VBoxGuestAdditions_6.1.6.iso    # Clipboard was working but now on new machine, for Stretch it doesn't work.
