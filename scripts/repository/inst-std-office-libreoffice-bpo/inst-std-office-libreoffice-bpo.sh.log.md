* >>>>>>>>> Running inst-std-office-libreoffice-bpo.sh ...
  ...
  * Disk size = 3434828K. Space Used = 406360K.
  * The following NEW packages will be installed:
  ```bash
  fonts-opensymbol libabw-0.1-1 libboost-date-time1.55.0 libclucene-contribs1
  libclucene-core1 libcurl3-gnutls libe-book-0.1-1 libeot0 libexttextcat-2.0-0
  ...
  libmythes-1.2-0 libneon27-gnutls libodfgen-0.1-1 libraptor2-0 librasqal3
